...
<head>
  ...
  <title>
    ...
    echo $xml->post[3]->title;  ?> | Matthew Windle - Web Developer
              </title>
...
<body class="blog-bg">
  ...
  <main id="skipnav" role="main" class="container post-page">
    ...
    <?php
      $path = $_SERVER['DOCUMENT_ROOT'];
      $xml = simplexml_load_file($path.'/blog.xml');
      echo "<p class='blog-date'> Post Date: " . $xml->post[3]->date . "</p>";
      echo $xml->post[3]->content;
      ?>
      <h4>Related links</h4>
      <div class="blog-footer">
        <div class="blog-button"><a href="/blog/The-futures-bright-the-futures-grids.php">The futures bright, the futures Grids</a></div>
      </div>
    </section>
    <aside>
      <h3>Archive</h3>
      ...
      <a href="/blog/.php" ><li>The futures bright, the futures Grids</li></a>
      <h4>February 2016</h4>
      <ul>
